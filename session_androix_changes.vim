...
map <silent> <F9> :WMToggle
noremap <silent> <F8> :TlistToggle
map <F5> g
map <F4> >
map <F3> +
map <F2>  
...
silent only
cd /c/prj/Android/flutterProjects/mxsa1905
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 android/build.gradle
badd +0 android/gradle.properties
badd +0 android/app/build.gradle
argglobal
silent! argdel *
$argadd android/build.gradle
...
exe '5resize ' . ((&lines * 8 + 28) / 56)
exe '6resize ' . ((&lines * 8 + 28) / 56)
argglobal
setlocal keymap=
setlocal noarabic
...
wincmd w
argglobal
if bufexists('android/app/build.gradle') | buffer android/app/build.gradle | else | edit android/app/build.gradle | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('android/gradle.properties') | buffer android/gradle.properties | else | edit android/gradle.properties | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists('android/build.gradle') | buffer android/build.gradle | else | edit android/build.gradle | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
